...
cols=['County','COVID-Free Days','New Cases in Last 14 Days', 'Last7', 'Previous7']
collect = []
...
tab.columns = ['County', 'COVID-Free Days', 'New Cases in Last 14 Days', 'Last 7 Days', 'Pct Change']
...
tab = tab[['Rank', 'County', 'COVID-Free Days', 'New Cases in Last 14 Days','Last 7 Days','Percent Change']]       
s = tab.style.apply(highlighter, axis = 1).set_table_styles(styles).hide_index()

try:        
    with open(f'Ireland.html', 'w', encoding="utf-8") as out:
