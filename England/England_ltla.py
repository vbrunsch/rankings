...
cols=['District (ltla)','COVID-Free Days','New Cases in Last 14 Days', 'Last7', 'Previous7']
collect = []
...
tab.columns = ['District (ltla)', 'COVID-Free Days', 'New Cases in Last 14 Days', 'Last 7 Days', 'Pct Change']
...
tab = tab[['Rank', 'District (ltla)', 'COVID-Free Days', 'New Cases in Last 14 Days','Last 7 Days','Percent Change']]       
s = tab.style.apply(highlighter, axis = 1).set_table_styles(styles).hide_index()

try:        
    with open(f'England_Districts_ltla.html', 'w', encoding="utf-8") as out:
