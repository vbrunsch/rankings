...
pdf_path4 = f'https://landkreis-freising.de/fileadmin/user_upload/Aktuelles_News/2021/Corona/Fallzahlen/Fallzahlen_nach_Gemeinden_{tod}.pdf'
...
try:
  ...
  try:
    ...
    try:
      ...
      try:
        dfs = tabula.read_pdf(pdf_path4, stream=True)
      except:
...
if tod == '28.06.2021':
  ...
  dfs = tabula.read_pdf('https://landkreis-freising.de/fileadmin/user_upload/Aktuelles_News/2021/Corona/Fallzahlen/Fallzahlen_nach_Gemeinden_8.11.2021.pdf', stream= True)
