...
old7 = pd.read_csv(f'Germany/NRW/LK_Muenchen/data/LK_München_{da7s}.csv', index_col = 0)
old14 = pd.read_csv(f'Germany/NRW/LK_Muenchen/data/LK_München_{da14s}.csv', index_col = 0)
