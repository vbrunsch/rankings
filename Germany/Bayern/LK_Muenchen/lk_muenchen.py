...
old7 = pd.read_csv(f'Germany/Bayern/LK_Muenchen/data/LK_München_{da7s}.csv', index_col = 0)
old14 = pd.read_csv(f'Germany/Bayern/LK_Muenchen/data/LK_München_{da14s}.csv', index_col = 0)
...
try:        
    with open(f'LK_München.html', 'w', encoding="utf-8") as out:
