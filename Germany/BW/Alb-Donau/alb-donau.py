...
filenames2 = re.findall('"id":"ADK_Corona_1000","layerType":"ArcGISFeatureLayer","url":"(.*)","visibility":true,"opacity":0.8,"title":"ADK_Corona"', t2)
...
zus.to_csv(f'Germany/BW/Alb-Donau/data/Alb-Donau_for_dw14_7.csv')
print(zus) 
...
try:        
    with open(f'Alb-Donau.html', 'w', encoding="utf-8") as out:
