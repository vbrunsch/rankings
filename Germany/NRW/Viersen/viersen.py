...
old7 = pd.read_csv(f'Germany/NRW/Viersen/data/Viersen_{da7s}.csv', index_col = 0)
old14 = pd.read_csv(f'Germany/NRW/Viersen/data/Viersen_{da14s}.csv', index_col = 0)
...
zus = zus[:-2]
print(zus)
zus.to_csv(f'Germany/NRW/Viersen/data/Viersen_for_dw14_7.csv') 
...
try:        
    with open(f'Viersen.html', 'w', encoding="utf-8") as out:
