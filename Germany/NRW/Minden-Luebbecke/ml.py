...
zus = zus.replace('HÃ¼llhorst','Hüllhorst')
zus = zus.replace('LÃ¼bbecke','Lübbecke')
zus = zus.replace('PreuÃisch Oldendorf','Preußisch Oldendorf')
...
try:        
    with open(f'Minden-Luebbecke.html', 'w', encoding="utf-8") as out:
