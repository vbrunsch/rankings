...
url_s = 'https://www.arcgis.com/sharing/rest/content/items/3f73221d4b384791b9a52c7327b72151/data'
...
filenames2 = re.findall('"id":"Corona_Gesamt_1741","layerType":"ArcGISFeatureLayer","url":"(.*)","visibility":true,"opacity":1,"title":"Corona_Gesamt"', t2)

que = filenames2[0] + '/query?where=0%3D0&outFields=%2A&f=json'
...
gem = re.findall('KOMMUNE":".. - (.*?)"',t3)
inf = re.findall('INFIZIER_3":(.*?),',t3)
infy = re.findall('INFIZIER_4":(.*?),',t3)
...
old7 = pd.read_csv(f'Germany/NRW/Steinfurt/data/Steinfurt_{da7s}.csv', index_col = 0)
old14 = pd.read_csv(f'Germany/NRW/Steinfurt/data/Steinfurt_{da14s}.csv', index_col = 0)
...
print(zus)
zus.to_csv(f'Germany/NRW/Steinfurt/data/Steinfurt_for_dw14_7.csv') 
...
try:        
    with open(f'Steinfurt.html', 'w', encoding="utf-8") as out:
