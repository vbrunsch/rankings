...
df = pd.read_excel('http://geovision.uned.ac.cr/oges/archivos_covid/2021_{0}/{0}_EXCEL_SERIES.xlsx'.format(yesterday), sheet_name='3_1 DIST_ACUM')
...
try:        
    with open(f'CostaRicaDistricts.html', 'w', encoding="utf-8") as out:
